Firmware for Freifunk Schwaben
=========================
...
[Precompiled firmware images](https://firmware.freifunk-schwaben.de/ "Precompiled firmware images") are available on our server. All other released versions here on github are out-of-date.
...
```bash
    ...
    git clone https://github.com/freezweb/firmware.git
